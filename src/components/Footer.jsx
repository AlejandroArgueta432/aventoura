        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Explorando el mundo juntos desde 2015. Ofrecemos las mejores experiencias para viajeros apasionados.
            </p>
          ...
          <div ref={contactRef}>
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                <a href="tel:+34123456789" className="text-gray-300 hover:text-white transition-colors">+34 123 456 789</a>
              </motion.li>
              <motion.li 
                className="flex items-center"
                whileHover={{ x: 3 }}
              ...
              >
                ...
                <a href="mailto:info@aventoura.com" className="text-gray-300 hover:text-white transition-colors">info@aventoura.com</a>
              </motion.li>
              <motion.li 
                className="flex items-center"
                whileHover={{ x: 3 }}
              ...
              >
                ...
                <a href="https://wa.me/34123456789" className="text-gray-300 hover:text-white transition-colors">WhatsApp</a>
              </motion.li>
            </ul>
          </div>
        </div>
